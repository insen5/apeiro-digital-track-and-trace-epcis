...
export default function FacilityProdDataPage() {
  ...
  return (
    <div className="p-6">
      {/* Header */}
      <div className="mb-6">
        <h1 className="text-3xl font-bold mb-2">Facility Production Data</h1>
        <p className="text-gray-600">
          Healthcare facility master data from Safaricom HIE Facility Registry (Production)
        </p>
      </div>

        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          <div className="p-5 bg-green-50 border border-green-200 rounded-lg">
            ...
            <div className="text-sm text-green-700">
              {((report.validity.validLicenses / report.overview.totalPractitioners) * 100).toFixed(1)}% of total
            </div>
          ...
          <div className="p-5 bg-yellow-50 border border-yellow-200 rounded-lg">
            ...
            <div className="text-sm text-yellow-700">
              {((report.validity.expiringSoon / report.overview.totalPractitioners) * 100).toFixed(1)}% of total
            </div>
          ...
          <div className="p-5 bg-red-50 border border-red-200 rounded-lg">
            ...
            <div className="text-sm text-red-700">
              {((report.validity.expiredLicenses / report.overview.totalPractitioners) * 100).toFixed(1)}% of total
            </div>

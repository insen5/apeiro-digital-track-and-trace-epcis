...
import { Users, BarChart3, CheckCircle, History } from 'lucide-react';
import PractitionerCatalogTab from './components/PractitionerCatalogTab';
...
export default function PractitionerDataPage() {
  ...
  const tabs = [
    { id: 'catalog' as TabType, label: 'Practitioner Catalogue', icon: Users },
  ...
  return (
    <div className="p-6">
      {/* Header */}
      <div className="mb-6">
        <h1 className="text-3xl font-bold mb-2">Practitioner Data</h1>
        <p className="text-gray-600">
          View and manage healthcare practitioner registrations from PPB
        </p>
      </div>
      ...
      {/* Tab Content */}
      {activeTab === 'catalog' && <PractitionerCatalogTab />}
